...
function createCartItemHTML(item, index, totalItems) {
    ...
    const addedFrom = isEvent ? 'イベント一覧' : '観光地一覧';
    return `
        <div class="accordion-item">
                    ...
                    <div class="d-flex align-items-center w-100">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small>
                                ...
                                <span class="ms-2">
                                    <i class="bi bi-clock-history"></i> 追加日時: ${new Date().toLocaleString()}
                                </span>
                                <span class="ms-2">
                                    <i class="bi bi-folder"></i> 追加元: ${addedFrom}
                                </span>
                            </small>
                        </div>
                    </div>
            ...
            <div id="item-${index}" class="accordion-collapse collapse show">
                <div class="accordion-body">
                    ${createItemDetailsHTML(item, index, totalItems)}
                </div>
            </div>
        </div>
    `;
...
// アイテム詳細のHTML生成
function createItemDetailsHTML(item, index, totalItems) {
    const isEvent = item.type === 'event';
    return `
        <div class="row">
            <div class="col-12 mb-3">
                ...
                ${createDetailsInfoHTML(item, isEvent)}
            </div>
...
// 詳細情報のHTML生成
function createDetailsInfoHTML(item, isEvent) {
...
>>>>>>> e0f3625453de583767beed0d51c6b6918fa4bc36
